  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: DecoratedBox(
        ...
        child: StreamBuilder<List<SensorEntity>>(
            stream: fetchSensors(emailResponsible: emailResponsible),
            builder: (context, sensorsSnapshot) {
              print('data: ${sensorsSnapshot.data}');
              if (sensorsSnapshot.hasData) {
                return Column(
                  children: [
                    ...
                    SensorCardList(
                      sensors: [
                        for (var sensor in sensorsSnapshot.data!)
                          SensorCard(
                            sensor: sensor,
                          )
                      ],
